...
export const useStudentExactQuery = (exactData) =>
  useQuery({
    queryKey: ["studentExact", exactData],
    queryFn: () => searchStudentExact(exactData),
    enabled: !!exactData && exactData.length >= 3, // ✅ only when typing
    staleTime: 10_000,
